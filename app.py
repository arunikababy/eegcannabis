...
# A softer palette used only by the Pre-Post tab. Decreases are encoded in
# blue rather than red so the figures remain calm and consistent with the
# green dashboard theme.
...
BCF_ACF_PREPOST_CHANNEL_FILLS = {
    "TP9": "rgba(23,76,91,0.18)",
    "AF7": "rgba(40,125,120,0.18)",
    "AF8": "rgba(85,166,143,0.18)",
    "TP10": "rgba(156,207,184,0.24)",
}
        ...
        for _, subject_row in channel_data.iterrows():
            ...
            figure.add_trace(
                go.Scatter(
                    ...
                    mode="lines+markers",
                    line={"color": "rgba(67,83,89,0.26)", "width": 1.5},
                    marker={
                        "size": 7,
                        "color": [
...
def render_bcf_acf_pre_post_visualizations():
    ...
    st.caption(
        "Compact horizontal bars show the proportion and count of paired "
